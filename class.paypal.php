...
// creates paypal auto submiting form with provide variables
   function submit_paypal_post($page_type = "") 
   {
      ...
      $html_r.= " <input type=\"submit\" value=\"Payment\" class=\"rc-processing-paypal-btn\"> </form>";
      if($page_type == "full")
      {
         // onLoad=\"document.forms['paypal_form'].submit();\">
         $html_r1 = " <html> <head><title>Processing Payment...</title></head> <body ";
         $html_r1 = '<div class="rc-processing-wrap-outer">';
         $html_r1.= '<div class="rc-processing-wrap" >'; 
         $html_r1.= ' <div class="rc-processing-loader"><img src="'.$this->image_path.'loader.svg" width="90" ></div>';
         $html_r1.= ' <div class="rc-processing-content">If you are not automatically redirected to paypal within few seconds please click payment button.</div>';
         $html_r1.= '<script type="text/javascript">
                     setTimeout(function(){
                        document.forms[\'paypal_form\'].submit();
                     }, 3000); // 5000 milliseconds = 5 seconds
                  </script>'; 
         $html_r1.= ' <div class="rc-processing-from">'.$html_r.'</div>';
